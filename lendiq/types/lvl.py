...
class LVLResult(BaseModel):
    ...
    hard_gates: list[LVLHardGate] | None = None
    signals_financial: list[LVLSignal] | None = None
    signals_business: list[LVLSignal] | None = None
    signals_contact: list[LVLSignal] | None = None
    signals_compliance: list[LVLSignal] | None = None
    signals_web: list[LVLSignal] | None = None
    signals_geographic: list[LVLSignal] | None = None
    signals_industry: list[LVLSignal] | None = None
...
class LVLRunListResponse(BaseModel):
...
class LVLStats(BaseModel):
    """Org-level LVL validation statistics."""
